...
public class Image extends system.proxies.FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("HMS.HelperLandingCarousel", mendixObject.getType())) {
			return hms.proxies.HelperLandingCarousel.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("HMS.SystemMedia", mendixObject.getType())) {
